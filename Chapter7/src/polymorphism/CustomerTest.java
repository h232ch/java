...
public class CustomerTest {
	...
	public static void main(String[] args) {
		...
		//상위클래스로 하위클래스의 인스턴스를 생성할때 -> 묵시적 형변환 상>하의 경우 자동 형변환의 성질이며 이를 Upcasting이라고 함
		...
		VIPCustomer customerKim  = new VIPCustomer(1000,"김세환");
		...
		Customer customerTest1 = new GoldCustomer(1002,"TEST1"); // VIPCustomer의 calcPrice의 메서드가 호출됨 -> 이것을 가상 메서드가 호출된다고 함
		customerTest1.bonusPoint = 1000;
		int priceTest1 = customerTest1.calcPrice(10000);
		System.out.println(customerTest1.showCustomerInfo() + "지불금액은 "+priceTest1 +"원 입니다.");
	}
